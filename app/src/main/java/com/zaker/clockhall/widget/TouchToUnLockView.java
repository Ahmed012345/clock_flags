package com.zaker.clockhall.widget;
...
import com.zaker.clockhall.lockscreen.utils.DimenUtils;
...
public class TouchToUnLockView extends FrameLayout {
    ...
    private void init() {
        ...
        mLockRipple = view.findViewById(R.id.rb_LockRipple);
        ...
        circlePaint.setColor(getResources().getColor(R.color.main_blue_color));
    }
