package com.zaker.clockhall.materialabout.builder;
...
import com.zaker.clockhall.materialabout.util.ColorUtil;
import com.zaker.clockhall.materialabout.util.IconUtil;
import com.zaker.clockhall.materialabout.util.IntentUtil;
import com.zaker.clockhall.materialabout.views.AboutView;
import com.zaker.clockhall.R;

import java.util.LinkedList;

import static com.zaker.clockhall.R.mipmap.share;
...
public final class AboutBuilder {
    ...
    public AboutBuilder setVersionNameAsAppSubTitle() {
        try {
            return setAppTitle(context.getString(com.zaker.clockhall.R.string.version, getPackageInfo().versionName));
